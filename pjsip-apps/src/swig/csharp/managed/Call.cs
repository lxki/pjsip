...
public class Call : global::System.IDisposable {
  ...
  public void forceSrtpKeys(SWIGTYPE_p_void tp, string tx_key, string rx_key) {
    pjsua2PINVOKE.Call_forceSrtpKeys(swigCPtr, SWIGTYPE_p_void.getCPtr(tp), tx_key, rx_key);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual void onStartMediaTransport(OnStartMediaTransportParam prm) {
    if (SwigDerivedClassHasMethod("onStartMediaTransport", swigMethodTypes19)) pjsua2PINVOKE.Call_onStartMediaTransportSwigExplicitCall(swigCPtr, OnStartMediaTransportParam.getCPtr(prm)); else pjsua2PINVOKE.Call_onStartMediaTransport(swigCPtr, OnStartMediaTransportParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("onStartMediaTransport", swigMethodTypes19))
      swigDelegate19 = new SwigDelegateCall_19(SwigDirectoronStartMediaTransport);
  ...
  private void SwigDirectoronStartMediaTransport(global::System.IntPtr prm) {
    onStartMediaTransport(new OnStartMediaTransportParam(prm, false));
  }
  ...
  private static global::System.Type[] swigMethodTypes19 = new global::System.Type[] { typeof(OnStartMediaTransportParam) };
}
