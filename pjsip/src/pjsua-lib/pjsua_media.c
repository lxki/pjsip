/* $Id: pjsua_media.c 5099 2015-05-20 08:46:11Z nanang $ */
/* 
    ...
    for (mi=0; mi < call->med_prov_cnt; ++mi) {
        ...
        if (call_med->type==PJMEDIA_TYPE_AUDIO) {
            ...
            if (si->dir == PJMEDIA_DIR_NONE) {
                ...
                /* Notify about starting media transport */
                if (pjsua_var.ua_cfg.cb.on_start_media_transport)
                {
                    (*pjsua_var.ua_cfg.cb.on_start_media_transport)(
                            call_id,
                            mi,
                            call_med->tp);
                }
